...
| **Are we faster?** | Practitioners: dramatically | METR 2025: 19% *slower*, while feeling 20% faster | The course does not try to settle it: you are adopting agents either way, so the answer would not change what you do. The durable lesson is that felt speed is unreliable — so measure your agentic practice against itself (M1) |
